...
<title>ServiceEngineer Registration Form</title>
	...
	<div class="container">
		...
		<form action="RegisterServiceEngineer" name="form" method="Post"
			...
			Enter Password:&nbsp;&nbsp;&nbsp;<input type="password"
				...
				pattern="(?=.*\d)(?=.*[a-z])(?=.*[^\w\s])(?=.*[A-Z]).{8,50}"
				title="Must contain at least one number, one uppercase, one lowercase letter and one special character with least 8 or more characters"
			...
			Confirm Password:&nbsp;&nbsp;&nbsp;<input type="password"
				name="confirmpassword" id="confirmpassword"> Department:<select
				...
				%>
			</select> &nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" name="option"
				value="RegisterServiceEngineer">
